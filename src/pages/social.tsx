...
const ENGAGEMENT_TASK_GROUPS: EngagementTask[][] = [
 [
   { id: "like_11",    label: "LIKE",    ember: 200, action: "like",    url: ENGAGEMENT_TWEET_URLS[0] },
   { id: "retweet_11", label: "RETWEET", ember: 300, action: "retweet", url: ENGAGEMENT_TWEET_URLS[0] },
   { id: "comment_11", label: "COMMENT", ember: 300, action: "comment", url: ENGAGEMENT_TWEET_URLS[0] },
 ],
];
